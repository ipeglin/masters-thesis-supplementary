...
def draw_layer(ax, x_pos, num_nodes, node_radius=0.12, color=None, label='Layer'):
    if color is None:
...
def plot_dense_network():
    ...
    layers = [
        {"num": 5, "name": "Input Layer", "color": _cp["wash"]},
        {"num": 7, "name": "Hidden Layer 1", "color": _cp["pale"]},
        {"num": 7, "name": "Hidden Layer 2", "color": _cp["pale"]},
        {"num": 3, "name": "Output Layer", "color": _cp["accent_a"]},
    ]
