...
def generate_cnn_3d_plot():
    ...
    layers = [
        ("Input", "224x224x3", 0.2, 10, 10, '#d3d3d3'),
        ("Stem\nConv/Pool", "56x56x64", 0.8, 8, 8, '#add8e6'),
        ("Dense\nBlock 1", "56x56x256", 1.5, 8, 8, '#ffb6c1'),
        ("Trans 1", "28x28x128", 0.5, 6, 6, '#90ee90'),
        ("Dense\nBlock 2", "28x28x512", 2.0, 6, 6, '#ffb6c1'),
        ("Trans 2", "14x14x256", 0.5, 4, 4, '#90ee90'),
        ("Dense\nBlock 3", "14x14x1792", 3.0, 4, 4, '#ffb6c1'),
        ("Trans 3", "7x7x896", 0.5, 2, 2, '#90ee90'),
        ("Dense\nBlock 4", "7x7x1920", 2.0, 2, 2, '#ffb6c1'),
        ("GAP", "1x1x1920", 0.5, 1, 1, '#90ee90'),
        ("Feature\nVector", "1920", 2.0, 0.5, 0.5, '#fa8072')
    ]
    ...
    legend_elements = [
        mpatches.Patch(facecolor='#d3d3d3', edgecolor='k', label='Input Image'),
        mpatches.Patch(facecolor='#add8e6', edgecolor='k', label='Conv / Pool'),
        mpatches.Patch(facecolor='#ffb6c1', edgecolor='k', label='Dense Block'),
        mpatches.Patch(facecolor='#90ee90', edgecolor='k', label='Transition / GAP'),
        mpatches.Patch(facecolor='#fa8072', edgecolor='k', label='Feature Vector')
    ]
