...
from plot_config import get_figs_output_dir
...
def plot_tie_breaker():
    ...
    circle4 = plt.Circle((0, 0), 1.08, color='green', fill=False, linestyle='--', label='k=4')
    circle5 = plt.Circle((0, 0), 1.26, color='orange', fill=False, linestyle=':', label='k=5')
